  ...
  "translation": {
    ...
    "dashboard": {
      ...
      "requests": {
        ...
        "requestBytes": "リクエスト本文：{{value}} バイト",
        "responseBytes": "レスポンス本文：{{value}} バイト",
      ...
      "backupRestore": {
        ...
        "export": {
          "heading": "エクスポート",
          "description": "ユーザー、API キー、アップストリーム、プロキシ、使用記録、検索プロバイダー設定を含む、コントロールプレーンデータの完全なスナップショットをダウンロードします。",
