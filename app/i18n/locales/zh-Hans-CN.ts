    ...
    translation: {
      ...
      dashboard: {
        ...
        performance: {
          ...
          groupBy: { label: "分组方式", model: "按模型", upstream: "按上游", operation: "按操作", runtimeLocation: "按区域", userId: "按用户", keyId: "按 API Key" },
          filters: { all: "全部", model: "模型", upstream: "上游", operation: "操作", runtimeLocation: "区域", userId: "用户", keyId: "API Key" },
          range: {
            label: "性能数据范围",
            today: "最近一天",
            sevenDays: "7 天",
