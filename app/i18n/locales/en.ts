    ...
    translation: {
      ...
      dashboard: {
        ...
        requests: {
          ...
          requestBytes: "Request body: {{value}} bytes",
          responseBytes: "Response body: {{value}} bytes",
        ...
        performance: {
          ...
          percentile: { label: "Latency percentile" },
          model: { label: "Performance model", all: "All models" },
          summary: {
          ...
          chartTitle: {
            byModel: "{{percentile}} Latency by Model",
            byPercentile: "{{model}} Latency by Percentile",
          },
          series: {
        ...
        modelAliases: {
          ...
          errors: { load: "Could not load aliases.", message: "Could not complete the alias operation: {{message}}" },
        },
        proxy: {
          heading: "Proxy",
          description:
