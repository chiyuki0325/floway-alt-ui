    ...
    translation: {
      ...
      dashboard: {
        ...
        apiKeys: {
          ...
          agentSetup: {
            setupTab: "Agent Setup", snippetsTab: "Config snippets", saving: "Saving…", selectKey: "Select an API key above to prepare a setup command.", preparing: "Preparing setup…", noKey: "Create an API key to use Agent Setup.", expired: "This setup link has expired. Retry to create a fresh link.", retry: "Retry", commandPending: "# Preparing setup command…", expires: "The setup link stays alive while this page is visible and expires after you leave.", defaultModel: "Default model", opusModel: "Opus model", sonnetModel: "Sonnet model", haikuModel: "Haiku model", reasoningEffort: "Reasoning effort", modelDefault: "Model default", noModelMatches: "No matching models", modelDiscovery: "Gateway model discovery", cleanupRetention: "Cleanup retention", cleanupDays: "{{count}} days", optOutAiAttribution: "Opt out of Claude Code AI attribution", unavailable: "{{id}} (unavailable)",
          },
          rotate: {
        ...
        upstreamEditor: {
          ...
          models: {
            ...
            pricingIssue: {
              ...
              invalidRate: "{{dimension}} must be zero or greater.",
              ...
              rateDimensions: "Every rule must use the same price types as the Base price.",
