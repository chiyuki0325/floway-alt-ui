    ...
    translation: {
      ...
      dashboard: {
        ...
        playground: {
          ...
          emptyResponse: "（空响应）",
          generating: "正在生成",
          noKey: "请先创建 API Key，再使用 Playground。",
        ...
        requests: {
          ...
          requestBytes: "请求体：{{value}} 字节",
          responseBytes: "响应体：{{value}} 字节",
          selectPrompt: "在右侧选择一条请求以查看详情。",
          noKeys: "没有 API key 启用请求保留。",
          noKeysDescription: "在 API key 上启用请求转储保留后，即可开始捕获请求。",
        ...
        performance: {
          ...
          chartTitle: {
            byModel: "按模型查看 {{percentile}} 延迟",
            byPercentile: "按百分位查看 {{model}} 延迟",
          },
          series: {
            label: "性能序列选择",
            all: "显示全部序列",
